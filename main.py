...
def main(page: ft.Page):
    ...
    lbl_contrasena = ft.Text(
        "Contraseña",           # Texto que se mostrará
        color="white",          # Color del texto
        size=20                 # Tamaño de la fuente
    )
    ...
    def ir_a_inicio(e):
        inicio_layout = inicio()                                   # Llama a la función inicio() que retorna un layout (Control)
        page.views.clear()                                         # Limpia las vistas actuales
        page.views.append(ft.View("/inicio", [inicio_layout]))     # Agrega la vista del inicio
    ...
    btn_aceptar = ft.ElevatedButton(
        "Aceptar",                      # Texto que se mostrará
        color="blue",                   # Texto azul
        bgcolor="white",                # Fondo blanco
        on_click=ir_a_inicio            # Al dar click te lleva a la pagina de inicio
    )
    ...
    btn_olvide = ft.ElevatedButton(
        "Olvide mi contraseña",             # Texto que se mostrará
        color="white",                      # Texto blanco
        bgcolor="red"                       # Fondo rojo
    )
